 ...
 * @LastEditTime: 2022-08-29 18:07:24
 * @@Email: ihusharp@gmail.com
 */
use std::{collections::{HashMap, BTreeMap}, path::{PathBuf, Path}, io::{Write, Seek, BufWriter, Read, BufReader, self}, fs::{File, self, OpenOptions}, ffi::OsStr, ops::Range};
...
impl KvStore {
    ...
    pub fn compact(&mut self) -> Result<()> {
        ...
        let stale_gens = self.readers.keys().filter(|&gen| *gen < compaction_gen).cloned().collect::<Vec<_>>();
